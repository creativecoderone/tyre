      ...
      _createClass(LocalityComponent, [{
        ...
        value: function getGeo() {
          ...
          setTimeout(function () {
            ...
            _this2.locs.getPosition().then(function (data) {
              console.log(data);
              _this2.positions = data;

              _this2.locs.goord(_this2.positions['lat'], _this2.positions['lng']).subscribe(function (datas) {
                console.log(datas);
              });
            });
          }, 4000);
        ...
        value: function locServ() {
          ...
          this.locs.getlocality().subscribe(function (data) {
            _this3.loader = false;
            _this3.location = data; // tslint:disable-next-line:forin

            for (var key in _this3.location) {
              _this3.location_keys.push(key);
            }
          }, function (err) {});
        }
      }, {
        ...
        value: function setGeo() {
          ...
          setTimeout(function () {
            ...
            _this5.eat("Geo Location setted", 1);
          }, 5000);
        }
      }, {
        key: "eat",
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function profile() {
          ...
          this.loc.profile(this.prof).subscribe(function (data) {
            if (data['status'] === true) {
              _this7.eat(data['msg'], 1);
            } else {
              _this7.eat(data['msg'], 2);
            }
          });
        }
      }, {
