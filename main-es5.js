...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppApplicationUserdataUserdataComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div id=\"snackbar\">{{msg}}</div>\r\n\r\n<!-- <h5>User profile</h5> -->\r\n<!-- <hr> -->\r\n<!-- {{profile|json}} -->\r\n\r\n<div class=\"row\">\r\n    <div class=\"col-md-4\"></div>\r\n    <div class=\"col-md-4\">\r\n        <div class=\"card text-center\">\r\n            <div class=\"card-header\">\r\n                <i class=\"far fa-smile\"></i>&nbsp;<b>{{profile?.username|uppercase}}</b>\r\n            </div>\r\n            <div class=\"card-body\">\r\n                <h5 class=\"card-title\"> \r\n                    <a [href]=\"'mailto:'+profile.email\"><i class=\"fas fa-envelope-square\"></i> {{profile?.email}}</a></h5>\r\n                <div class=\"card-text\">\r\n                    Profile created on <br>\r\n                 <p class=\"text-warning\"><b> <i class=\"fas fa-calendar-week\"></i> {{profile?.date|date:'full'}}</b></p>\r\n                </div>\r\n                <a class=\"btn btn-outline-primary\">\r\n                    <i class=\"fas fa-mobile\"></i> {{profile?.mobile}}\r\n                </a>\r\n            </div>\r\n            <div class=\"card-footer text-muted\">\r\n                #{{profile?._id}}\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"col-md-4\"></div>\r\n</div>\r\n<div class=\"row\">\r\n    <div class=\"col-sm-6\">\r\n        <div class=\"card\">\r\n            <div class=\"card-body\">\r\n                <h5 class=\"card-title\">Special title treatment</h5>\r\n                <p class=\"card-text\">With supporting text below as a natural lead-in to additional content.</p>\r\n                <a  href=\"#\" class=\"btn rr btn-primary\">Go somewhere</a>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"col-sm-6\">\r\n        <div class=\"card\">\r\n            <div class=\"card-body\">\r\n                <h5 class=\"card-title\">Special title treatment</h5>\r\n                <p class=\"card-text\">With supporting text below as a natural lead-in to additional content.</p>\r\n                <a href=\"#\" class=\"btn rr btn-primary\">Go somewhere</a>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _application_disclaimer_disclaimer_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./application/disclaimer/disclaimer.component */
    "./src/app/application/disclaimer/disclaimer.component.ts");
    /* harmony import */


    var _application_userdata_userdata_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./application/userdata/userdata.component */
    "./src/app/application/userdata/userdata.component.ts");
  ...
  function srcAppApplicationUserdataUserdataComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".card {\n  margin: 5px 0px;\n}\n\n.rr {\n  float: right;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(UserdataComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.loc.userprofile(prof).subscribe(function (data) {
            _this9.profile = data[0]; // this.eat('Sucess', 1);
          });
        }
      }, {
        key: "eat",
      ...
      _createClass(ShiftComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.loc.getYellow().subscribe(function (data) {
            _this10.info = data; // console.log(this.info.length);
          });
        }
      }, {
        key: "logins",
        value: function logins() {
          ...
          this.loc.usercheck(this.login).subscribe(function (ccc) {
            if (ccc['status'] === false) {
              _this11.loc.login(_this11.login).subscribe(function (data) {
                ...
                if (data['status'] === true) {
                  ...
                  _this11.logdata = false;
                  window.localStorage.setItem("logged", _this11.login.username);

                  _this11.router.navigate(['/profile']); // this.router.navigateByUrl('/profile',{skipLocationChange:true}).then(()=>{
                  //   this.router.navigate([decodeURI(this.location.path())]);
                  // })
              ...
              _this11.eat('Username not exists', 2);
            }
          });
        }
      }, {
        ...
        value: function register() {
          ...
          this.loc.usercheck(this.login).subscribe(function (ccc) {
            if (ccc['status'] === true) {
              if (_this12.login.password === _this12.login.cpassword) {
                _this12.loc.register(_this12.login).subscribe(function (data) {
                  _this12.logdata = undefined;
                  _this12.enter = true;
                  _this12.reg = true;
                  _this12.regData = data['msg'];
                ...
                _this12.eat('Password not matched', 2);
              }
            } else {
              _this12.logdata = undefined;
              _this12.enter = true;
